...
| **Samples 4 or more days in transit** | `r format(o$transit_over_4, big.mark=",", trim=TRUE)` | `r o$percent_over_4`% | `r toOrdinal(o$rank_transit_over_4)` of `r state$submitters` | `r state$percent_over_4`% |
